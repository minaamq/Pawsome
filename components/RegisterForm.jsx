                        ...
                        <div className=" sm:px-6 px-4 py-8 w-[500px] max-xl:mx-auto">
                            <form onSubmit={handleSubmit}>
                                <div className="mb-6 text-center">
                                    ...
                                    <h4 className="text-sm font-extrabold text-gray-300 mt-4 ">Register to Pawsome</h4>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative flex items-center">
                                        <input name="name" type="text"  className="w-full rounded-sm text-sm text-gray-800 border border-gray-300 px-4 py-3  outline-blue-600" placeholder="Enter name"
                                ...
                                <div className="mt-5">
                                    <div className="relative flex items-center">
                                        <input name="email" type="email"   onChange={e=> setEmail(e.target.value)}
                                         className="w-full rounded-sm text-sm text-gray-800 border border-gray-300 px-4 py-3  outline-blue-600" placeholder="Enter email" />

                                    </div>
                                </div>
                                <div className="mt-5">
                                    <div className="relative flex items-center">
                                        <input name="password" type="password" onChange={(e)=> setPassword(e.target.value)} autoComplete='password' className="w-full rounded-sm text-sm text-gray-800 border border-gray-300 px-4 py-3  outline-blue-600" placeholder="Enter password" />
                                ...
                                <div className="mt-4">
                                    <button type="submit" className="w-full shadow-xl py-4 px-6 text-sm font-semibold rounded-sm text-white bg-orange-400 hover:bg-yellow-600 focus:outline-none">Register</button>
                                </div>
                                {error && (
                                ...
                                <p className="text-sm mt-8 text-center text-gray-800"><Link href={"/"} className="text-gray-300 font-semibold hover:underline ml-1 whitespace-nowrap">Already have an account?</Link></p>
                            </form>
                        </div>
                    </div>
                </div>
